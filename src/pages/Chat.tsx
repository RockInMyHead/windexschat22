                ...
                <Button
                  ...
                  onClick={(e) => {
                    ...
                    if (voiceInput.isRecording) {
                      ...
                      console.log('🎤 Second button press - stopping recording manually');
                      setVoiceRecordingStoppedManually(true); // Устанавливаем флаг для отправки сообщения
                      voiceInput.stopRecording();
                      // Дополнительная проверка через небольшую задержку, чтобы убедиться, что запись остановлена
                      setTimeout(() => {
                        if (voiceInput.isRecording) {
                          console.log('🎤 Recording still active after stop, forcing stop again');
                          voiceInput.stopRecording();
                        }
                      }, 200);
                    } else {
